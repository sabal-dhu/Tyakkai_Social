        ...
        <div className="col-md-6 col-lg-3">
          <div className="card h-100">
            <div className="card-body">
              <h6 className="card-subtitle mb-1 text-muted">Total Engagement</h6>
              <h2 className="card-title h1 mb-2">{formatNumber(analyticsData.summary.totalEngagement)}</h2>
        ...
        <div className="col-md-6 col-lg-3">
          <div className="card h-100">
            <div className="card-body">
              ...
              <h2 className="card-title h1 mb-2">{formatNumber(analyticsData.summary.impressions)}</h2>
              <p className="card-text text-success mb-0 d-flex align-items-center">
                <svg
                  xmlns="http://www.w3.org/2000/svg"
                  width="16"
        ...
        <div className="col-md-6 col-lg-3">
          <div className="card h-100">
            <div className="card-body">
              ...
              <h2 className="card-title h1 mb-2">{formatNumber(analyticsData.summary.clicks)}</h2>
              <p className="card-text text-success mb-0 d-flex align-items-center">
                <svg
                  xmlns="http://www.w3.org/2000/svg"
                  width="16"
        ...
        <div className="col-md-6 col-lg-3">
          <div className="card h-100">
            <div className="card-body">
              ...
              <h2 className="card-title h1 mb-2">{formatNumber(analyticsData.summary.shares)}</h2>
              <p className="card-text text-success mb-0 d-flex align-items-center">
                <svg
                  xmlns="http://www.w3.org/2000/svg"
                  width="16"
      ...
      <div className="row g-4 mb-5">
        {Object.values(analyticsData.platforms).map((platform) => (
          <div className="col-md-4" key={platform.name}>
            <div className="card h-100">
              <div className="card-header" style={{ backgroundColor: platform.color, color: "white" }}>
                ...
                <div className="row g-3">
                  <div className="col-6">
                    <div className="d-flex flex-column">
                      ...
                      <span className="fw-bold">{formatNumber(platform.engagement)}</span>
                      <span className="small text-success">+{platform.engagementGrowth}%</span>
                    </div>
                  </div>
                  <div className="col-6">
                    <div className="d-flex flex-column">
                      <span className="text-muted small">Impressions</span>
                      <span className="fw-bold">{formatNumber(platform.impressions)}</span>
                      <span className="small text-success">+{platform.impressionsGrowth}%</span>
                    </div>
                  </div>
                  <div className="col-6">
                    <div className="d-flex flex-column">
                      <span className="text-muted small">Clicks</span>
                      <span className="fw-bold">{formatNumber(platform.clicks)}</span>
                      <span className="small text-success">+{platform.clicksGrowth}%</span>
                    </div>
                  </div>
                  <div className="col-6">
                    <div className="d-flex flex-column">
                      <span className="text-muted small">Shares</span>
                      <span className="fw-bold">{formatNumber(platform.shares)}</span>
                      <span className="small text-success">+{platform.sharesGrowth}%</span>
                    </div>
                  </div>
                </div>
              </div>
        ...
        <div className="card-body">
          <div style={{ height: "300px" }} className="d-flex align-items-end">
            {analyticsData.engagementByDay.slice(-14).map((day, index) => (
              <div key={index} className="d-flex flex-column align-items-center" style={{ flex: 1 }}>
                <div className="d-flex flex-column-reverse" style={{ height: "250px" }}>
                  <div
          ...
          <div className="d-flex justify-content-center mt-3">
            <div className="d-flex align-items-center me-3">
              <div className="bg-primary me-2" style={{ width: "10px", height: "10px" }}></div>
              <small>Facebook</small>
            </div>
            <div className="d-flex align-items-center me-3">
              <div className="me-2" style={{ width: "10px", height: "10px", backgroundColor: "#8a3ab9" }}></div>
              <small>Instagram</small>
            </div>
            <div className="d-flex align-items-center">
              <div className="bg-info me-2" style={{ width: "10px", height: "10px" }}></div>
              <small>Twitter</small>
            </div>
          </div>
        </div>
