  ...
  return (
    <DashboardLayout>
      <div className="d-flex justify-content-between align-items-center mb-4">
        ...
        <button className="btn btn-primary d-flex align-items-center" onClick={() => setShowCreateModal(true)}>
          <svg
      ...
      {loading ? (
        ...
        <div className="alert alert-info">No posts found. Create a new post to get started!</div>
      ) : (
            ...
            <tbody>
              {posts.map((post) => (
                <tr key={post.id}>
                  <td>
                    <div
                      style={{ maxWidth: "300px", maxHeight: "100px", overflow: "hidden", textOverflow: "ellipsis" }}
                    >
                      {post.content}
                  ...
                  <td>
                    <div className="btn-group">
                      <button className="btn btn-sm btn-outline-primary" onClick={() => handleEditPost(post)}>
                        Edit
                      </button>
                      <button className="btn btn-sm btn-outline-danger" onClick={() => handleDeletePost(post.id)}>
                        Delete
                      </button>
                    </div>
                  </td>
